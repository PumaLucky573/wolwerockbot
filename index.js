...
if(cmd === `${prefix}botinfo`){
  ...
  .addField(`Discord:`, `[Raccrew](https://discord.gg/aRE4Jae) |` + ` [Raccoon Aiming](https://discord.gg/f7CT8yy) |` + ` [Tonis Labor](https://discord.gg/9Ym8zdr)`, true)
...
if(cmd === `${prefix}8ball`) {
 ...
 let ballembed = new Discord.RichEmbed()
  .setAuthor(`Toni Raccoons 8Ball`, bot.user.avatarURL)
